// Replaces `analyzeMatchups` in backend/index.js
...
async function analyzeMatchups(deckCards) {
  ...
  const recommendations = `This deck leans ${curve.creatures > curve.nonCreatures ? "aggressive (creature-heavy)" : "control (spell-heavy)"}. ` +
